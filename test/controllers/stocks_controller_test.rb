...
class StocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stock" do
    assert_difference('Stock.count') do
      post stocks_url, params: { stock: { portfolio: @stock.portfolio, ticker: @stock.ticker } }
    end
  ...
  test "should update stock" do
    patch stock_url(@stock), params: { stock: { portfolio: @stock.portfolio, ticker: @stock.ticker } }
